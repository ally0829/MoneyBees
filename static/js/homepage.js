                ...
                upcomingList.innerHTML = !data.upcoming_expenses || data.upcoming_expenses.length === 0
                    ...
                    : data.upcoming_expenses.map(payment => `
                        <div class="payment-item">
                            <span>${payment.category}</span> <span>-${globalCurrencySymbol}${payment.amount} (Due: ${payment.due_date})</span>
                        </div>
                    `).join('');
            })
                        ...
                        return `
                            <div class="target-item">
                                ...
                                <div class="target-progress-container">
                                    ...
                                    <div class="target-amount">${globalCurrencySymbol}${target.current_spent} / ${globalCurrencySymbol}${target.target_amount}</div>
                                </div>
                            </div>
                        `;
                    }).join('');
